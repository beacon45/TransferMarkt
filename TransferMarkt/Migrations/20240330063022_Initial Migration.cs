    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Playerss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Playerss_AspNetUsers_IdentityUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bids_Playerss_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Playerss",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Negotiates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Negotiates_AspNetUsers_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Negotiates_Playerss_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Playerss",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Negotiates_IdentityUserId",
                table: "Negotiates",
                column: "IdentityUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Negotiates_ListingId",
                table: "Negotiates",
                column: "ListingId");

            migrationBuilder.CreateIndex(
                name: "IX_Playerss_IdentityUserId",
                table: "Playerss",
                column: "IdentityUserId");
        }
